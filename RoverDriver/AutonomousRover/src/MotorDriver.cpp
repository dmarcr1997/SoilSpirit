...
void motorsLeft() {
  analogWrite(F_MOTOR_LEFT_IN1, 155);
  analogWrite(F_MOTOR_LEFT_IN2, 0);
  analogWrite(F_MOTOR_RIGHT_IN3, 255);
  analogWrite(F_MOTOR_RIGHT_IN4, 0);

  // Middle motors
  analogWrite(M_MOTOR_LEFT_IN1, 155);
  analogWrite(M_MOTOR_LEFT_IN2, 0);
  analogWrite(M_MOTOR_RIGHT_IN3, 255);
  analogWrite(M_MOTOR_RIGHT_IN4, 0);

  // Back motors
  analogWrite(B_MOTOR_LEFT_IN1, 155);
  analogWrite(B_MOTOR_LEFT_IN2, 0);
  analogWrite(B_MOTOR_RIGHT_IN3, 255);
  analogWrite(B_MOTOR_RIGHT_IN4, 0);
  delay(MOVEMENT_DELAY);
}

void motorsRight() {
    analogWrite(F_MOTOR_LEFT_IN1, 255);
  analogWrite(F_MOTOR_LEFT_IN2, 0);
  analogWrite(F_MOTOR_RIGHT_IN3, 155);
  analogWrite(F_MOTOR_RIGHT_IN4, 0);

  // Middle motors
  analogWrite(M_MOTOR_LEFT_IN1, 255);
  analogWrite(M_MOTOR_LEFT_IN2, 0);
  analogWrite(M_MOTOR_RIGHT_IN3, 155);
  analogWrite(M_MOTOR_RIGHT_IN4, 0);

  // Back motors
  analogWrite(B_MOTOR_LEFT_IN1, 255);
  analogWrite(B_MOTOR_LEFT_IN2, 0);
  analogWrite(B_MOTOR_RIGHT_IN3, 155);
  analogWrite(B_MOTOR_RIGHT_IN4, 0);
}
...
void motorsBackwards() {
  ...
  // Front motors
  analogWrite(F_MOTOR_LEFT_IN1, 0);
  analogWrite(F_MOTOR_LEFT_IN2, 191);
  analogWrite(F_MOTOR_RIGHT_IN3, 0);
  analogWrite(F_MOTOR_RIGHT_IN4, 191);

  // Middle motors
  analogWrite(M_MOTOR_LEFT_IN1, 0);
  analogWrite(M_MOTOR_LEFT_IN2, 191);
  analogWrite(M_MOTOR_RIGHT_IN3, 0);
  analogWrite(M_MOTOR_RIGHT_IN4, 191);

  // Back motors
  analogWrite(B_MOTOR_LEFT_IN1, 0);
  analogWrite(B_MOTOR_LEFT_IN2, 191);
  analogWrite(B_MOTOR_RIGHT_IN3, 0);
  analogWrite(B_MOTOR_RIGHT_IN4, 191);
  delay(MOVEMENT_DELAY);
}
